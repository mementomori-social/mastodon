...
export const deleteModal = getMeta('delete_modal') ?? true;
export const disableSwiping = getMeta('disable_swiping') ?? false;
export const disableHoverCards = getMeta('disable_hover_cards') ?? false;
