    ...
    return (
      <div className='compose-form__poll-wrapper'>
        ...
        <div className='poll__footer'>
          <button type='button' disabled={options.size >= 15} className='button button-secondary' onClick={this.handleAddOption}><Icon id='plus' icon={AddIcon} /> <FormattedMessage {...messages.add_option} /></button>
